...
bc_land_C = BCLand_C()
seaward_salinity = 0.035
landward_salinity = 0.0
constant_contributions = np.load(r'C:\Users\Jonas\Documents\MASCOT\SourceCode\pyMANGA-1\My_Model\ronny_3\constant_contributions.npy')
salinity_prefactors = np.load(r'C:\Users\Jonas\Documents\MASCOT\SourceCode\pyMANGA-1\My_Model\ronny_3\salinity_prefactors.npy')
complete_contributions = None
cumsum_savename = r'C:\Users\Jonas\Documents\MASCOT\SourceCode\pyMANGA-1\My_Model\ronny_3\cumsum_salinity.npy'
calls_savename = r'C:\Users\Jonas\Documents\MASCOT\SourceCode\pyMANGA-1\My_Model\ronny_3\calls_in_last_timestep.npy'
t_write = 316076000.0
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
cell_information = CellInformation(r'C:\Users\Jonas\Documents\MASCOT\SourceCode\pyMANGA-1\My_Model\ronny_3\my_first_source.vtu')
