...
result_files =\
    glob.glob(
    r'C:\Users\embdm\Dokumente\FreieUniBerlin\Bachelorarbeit\MASCOT\SourceCode\pyMANGA\previous_setups\TreeOutput\*.csv')
...
for time in ts:
    ...
    time = round((time / 86400 / 365.25), 5)
    ...
    #Path("/model_final_Emma/").mkdir(parents=True, exist_ok=True)
